...
def plot_simulation(x_asteroid, y_asteroid, z_asteroid, sim):
    ...
    ax.plot(x_asteroid, y_asteroid, z_asteroid, color='red', label="Asteroid Path")
...
asteroid_position = [0.21, 0.21, 1.43]
asteroid_velocity = [0.0, 1.1, 0.0]
simulation = initialize_simulation()
x_path, y_path, z_path = simulate_asteroid_path(asteroid_position, asteroid_velocity, simulation, duration=2000)
plot_simulation(x_path, y_path, z_path, simulation)
